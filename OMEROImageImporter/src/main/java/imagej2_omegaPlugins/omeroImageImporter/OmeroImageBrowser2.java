...
//	private ConvertService cs;
	...
	private OmeroImageJPanel2 panel;
	...
	public void run() {
		...
		panel = new OmeroImageJPanel2(frame, gateway, this);
...
//		}
	...
	public void loadImage(Long id) {
		...
		Dataset dataset = (Dataset) op.run(OmeroImageReader3.class, client, id);
		ui.show(dataset);
	...
	public static void main(final String... args) {
		...
		ij.command().run(OmeroImageBrowser2.class, true);
	}
}
